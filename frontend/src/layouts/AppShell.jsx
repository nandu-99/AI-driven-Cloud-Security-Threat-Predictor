...
export default function AppShell() {
  ...
  useEffect(() => {
    ...
    getNotifications(role)
      .then(res => setNotificationCount(Array.isArray(res) ? res.length : 0))
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      <Navbar showNotif={showNotif} setShowNotif={setShowNotif} notificationCount={notificationCount} />
      {showNotif && (
        <NotificationsPanel role={role} onClose={() => setShowNotif(false)} />
      )}
