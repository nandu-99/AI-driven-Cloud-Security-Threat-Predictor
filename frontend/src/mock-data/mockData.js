...
export const MOCK_USERS = [
  { id: 'USR-0999', risk: 'Critical', status: 'Under Investigation', loginAttempts: 24, failedLogins: 15, fileAccess: 60, session: '5h 11m', ts: '2025-01-15 08:25' },
...
export const USER_NOTIFICATIONS = [
  { title: 'Unusual login access detected from new device', time: '2 hours ago' },
  { title: 'Password update recommended — change overdue', time: '5 hours ago' },
  { title: 'Login from unrecognised geographic location', time: '1 day ago' },
]

export const ANALYST_NOTIFICATIONS = [
  { title: 'Unusual privileged file access by USR-1043 — urgent review', time: '14 min ago' },
  { title: 'Excess login attempts with failures — USR-1072 possible brute force', time: '1 hour ago' },
  { title: 'Session from new location — USR-1021 under investigation', time: '3 hours ago' },
]

export const ADMIN_NOTIFICATIONS = [
  { title: 'User USR-1072 escalated — requires immediate action', time: '8 min ago' },
  { title: 'Log ingestion delay detected — pipeline lag', time: '45 min ago' },
  { title: 'Monthly compliance audit report generated', time: '2 hours ago' },
]
...
export const MOCK_ALERTS = [
  ...
  { id: 'USR-1055', level: 'low',    desc: 'Minor deviation detected — behaviour consistent with normal access patterns', time: '11:05' },
  { id: 'USR-1043', level: 'low',    desc: 'Low severity anomaly — single location check flagged, resolved on follow-up', time: '13:20' },
]
